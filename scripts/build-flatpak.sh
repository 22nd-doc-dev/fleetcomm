...
flatpak build-bundle "$REPO" "dist/FleetComm-$VERSION-linux-x86_64.flatpak" "$APP_ID" stable
ls -la "dist/FleetComm-$VERSION-linux-x86_64.flatpak"
echo "built dist/FleetComm-$VERSION-linux-x86_64.flatpak from $MANIFEST"
